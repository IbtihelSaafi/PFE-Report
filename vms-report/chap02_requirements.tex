...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{usecase.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{uml_diagram_1.png}
\caption{Additional UML Diagram — Static View}
\label{fig:uml-static}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{uml_diagram_2.png}
\caption{Additional UML Diagram — Dynamic Interaction View}
